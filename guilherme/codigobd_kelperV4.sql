...
create table leitura(
    ...
    leitura 		float , 					-- Valor para armazenar todos os valores obtidos pelos sensores em lúmens.
    fksensor        int,
    createdAt 			datetime						-- Data de quando a leitura foi feit
);

alter table leitura add constraint fksenL foreign key (fksensor) references sensorlum(idSensorL);
